...
--
-- Host: 127.0.0.1    Database: sharing_expenses
-- ------------------------------------------------------
...
CREATE TABLE `accounts` (
  ...
  PRIMARY KEY (`id`),
  KEY `accounts_ibfk_1` (`group_id`),
  KEY `accounts_ibfk_2` (`user_id`),
...
INSERT INTO `users` VALUES (1,'Linas','linas@linas.gmail.com','$2b$10$QiPi3NChtHMNKgDGAJszTOuN4a8EQ0FCP408FtCNoU9ijXEO3pXXy','2023-07-02 11:52:45');
...
-- Dump completed on 2023-07-03 21:46:00
